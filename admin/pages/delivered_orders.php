...
$query_1 = "SELECT * FROM `orders`WHERE status = 'confirmed'";
...
foreach ($result_1 as $key => $value) {
       ...
       echo "<tr><td>$order_date</td><td>$order_code</td><td><a href = 'order.php?order_code=$order_code&token_32=true'>Check</a></td></tr>"; 
